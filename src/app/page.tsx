      ...
      features={[
        {
          ...
          description: "Achieve your perfect smile with our advanced whitening and cosmetic alignment solutions.",
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-happy-young-successful-woman-giving-two-thumbs-up-gesture_273609-13742.jpg",
          imageAlt: "Cosmetic Result",
        },
        {
          title: "Family Care",
          description: "Gentle, comfort-focused care for patients of all ages, ensuring positive long-term oral health.",
          imageSrc: "http://img.b2bpic.net/free-photo/doctor-doing-their-work-pediatrics-office_23-2149224181.jpg",
          imageAlt: "Family Smiling",
        },
        {
          title: "Advanced Clinical Tech",
          description: "State-of-the-art diagnostic and treatment technology for efficient, pain-free dental experiences.",
      ...
      testimonials={[
        {
          ...
          name: "Sarah Johnson",
          handle: "@sarahj",
          testimonial: "The best dental experience I've ever had. Truly luxurious.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-feminine-tender-sensual-redhead-woman-with-curly-hair-with-messy-bun-embrace-her-neck-white_176420-41935.jpg",
        },
        {
          id: "2",
          name: "Michael Chen",
          handle: "@mchen",
          testimonial: "Efficient, expert, and incredibly comfortable.",
          rating: 5,
        ...
        },
        {
          ...
          handle: "@emilyrod",
          testimonial: "My kids actually enjoy visiting the dentist now!",
          rating: 5,
        ...
        },
        {
          ...
          name: "David Kim",
          handle: "@dkim",
          testimonial: "Professional results and a fantastic aesthetic.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Jessica Lee",
          handle: "@jlee",
          testimonial: "Village Dental is my new go-to for all dental needs.",
          rating: 5,
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        ...
        },
        {
          id: "m3",
          value: "24/7",
          description: "Emergency Consultations",
        },
      ]}
      ...
      faqs={[
        {
          ...
          content: "Yes, we are currently accepting new adult and pediatric patients.",
        },
        {
          id: "f2",
          title: "What payment options do you offer?",
          content: "We offer transparent pricing and work with major insurance providers.",
        },
        {
          id: "f3",
          title: "How do I schedule an appointment?",
          content: "You can schedule through our online portal or call us directly.",
        },
      ]}
      ...
      blogs={[
        {
          ...
          excerpt: "Essential daily habits for your dental health.",
          ...
          authorName: "Dr. Smith",
          authorAvatar: "http://img.b2bpic.net/free-photo/caucasian-woman-smiling-face-expression-headshot-portrait_53876-65110.jpg",
          date: "Jan 12, 2024",
        },
        {
          id: "b2",
          category: "Cosmetic",
          title: "Whitening Options Explained",
          excerpt: "The truth about home vs professional whitening.",
          ...
          authorName: "Dr. Doe",
          authorAvatar: "http://img.b2bpic.net/free-photo/smiling-man-leaning-fist-looking-camera_23-2148179009.jpg",
          date: "Feb 05, 2024",
        },
        {
          id: "b3",
          category: "Tips",
          title: "Kids and Dentistry",
          excerpt: "How to make dental visits fun for children.",
          imageSrc: "http://img.b2bpic.net/free-photo/family-sitting-sofa-smiling_1098-1328.jpg",
          authorName: "Dr. Adams",
          authorAvatar: "http://img.b2bpic.net/free-photo/smiling-businesswoman-city-with-blurred-background_1139-257.jpg",
          date: "Mar 20, 2024",
        },
      ]}
    />
