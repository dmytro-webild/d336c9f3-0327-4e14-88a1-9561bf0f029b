...
export default function LandingPage() {
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        {
          id: "1",          name: "Sarah Johnson",          handle: "@sarahj",          testimonial: "The best dental experience I've ever had. Truly luxurious.",          rating: 5,
        ...
        {
          id: "2",          name: "Michael Chen",          handle: "@mchen",          testimonial: "Efficient, expert, and incredibly comfortable.",          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/contemplated-serious-young-man-looking-camera_23-2148130297.jpg"},
        {
          id: "3",          name: "Emily Rodriguez",          handle: "@emilyrod",          testimonial: "My kids actually enjoy visiting the dentist now!",          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-redhead-non-binary-person_23-2148760579.jpg"},
        {
          id: "4",          name: "David Kim",          handle: "@dkim",          testimonial: "Professional results and a fantastic aesthetic.",          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-serious-concentrated-man-white-shirt_171337-17406.jpg"},
        {
          id: "5",          name: "Jessica Lee",          handle: "@jlee",          testimonial: "Village Dental is my new go-to for all dental needs.",          rating: 5,
